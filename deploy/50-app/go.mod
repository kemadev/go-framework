module github.com/kemadev/go-framework/deploy/50-app
...
require (
	...
	github.com/kemadev/ci-cd v0.21.0 // indirect
	github.com/kemadev/go-framework v0.0.0-20250715073129-3eb4db2e981e // indirect
